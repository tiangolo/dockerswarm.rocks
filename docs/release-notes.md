...
* Add notes about starting Traefik in host mode. To be able to get the real IP from clients. Here's the updated [documentation for distributed Traefik](https://dockerswarm.rocks/traefik/#getting-the-client-ip) and here's the updated [documentation for a single Traefik using a volume](https://dockerswarm.rocks/traefik-with-volume/#getting-the-client-ip).

## 0.1.0

* Add [Swarmpit](https://swarmpit.io/) with deployment stack compatible with [DockerSwarm.rocks](https://dockerswarm.rocks).
